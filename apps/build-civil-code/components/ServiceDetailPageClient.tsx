...
import { ArrowLeft, ArrowRight, CheckCircle2, Clock3, Layers3, Sparkles, Wrench } from 'lucide-react'
import { motion } from 'framer-motion'
import NavbarClient from '@/components/NavbarClient'
import FooterClient from '@/components/FooterClient'
import { itemReveal, sectionReveal } from './motion'
import { serviceCatalog, type ServiceItem } from '@/lib/services'
...
export default function ServiceDetailPageClient({ service, layoutSettings }: Props) {
        ...
        <div className="relative mx-auto w-full max-w-[1800px] px-5 pb-14 sm:px-6 md:px-10 lg:px-16">
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <MotionDiv className="flex flex-col justify-end" variants={itemReveal}>
              ...
              <h1 className="mt-6 max-w-4xl text-[clamp(3rem,8.2vw,8.6rem)] font-black leading-[0.88] tracking-[-0.065em] text-[#1c1712]">
                {service.title}
              </h1>
            ...
            <MotionDiv className="relative flex items-end" variants={itemReveal}>
              <div className="relative min-h-[480px] w-full overflow-hidden rounded-[40px] border border-[#73A5CA]/14 bg-[#FEFDDF] shadow-[0_30px_90px_rgba(28,23,18,0.12)] sm:min-h-[620px]">
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(180deg, rgba(255,253,223,0.10), rgba(28,23,18,0.42)), url('${service.image}')`,
                  }}
                />
                ...
                <div className="absolute bottom-5 left-5 right-5 rounded-[28px] border border-[#73A5CA]/14 bg-[#FEFDDF]/90 p-5 shadow-[0_10px_28px_rgba(28,23,18,0.08)] backdrop-blur-xl sm:right-auto sm:max-w-lg">
                  ...
                  <p className="mt-3 text-sm leading-6 text-[#6e6256]">{service.intro}</p>
                </div>
                ...
                >
                  <div className="text-[11px] uppercase tracking-[0.28em] text-[#5d8fb2]">Design rhythm</div>
            ...
            >
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-3">
                {service.details.map((detail) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-[#6e6256]">{detail}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {service.gallery.map((image, index) => (
                  <div
                    key={image}
                    className="relative min-h-[260px] overflow-hidden rounded-[28px] border border-[#73A5CA]/12 bg-cover bg-center shadow-[0_16px_40px_rgba(28,23,18,0.08)]"
                    style={{
                      backgroundImage: `linear-gradient(180deg, rgba(255,253,223,0.06), rgba(28,23,18,0.22)), url('${image}')`,
                    }}
                  >
            ...
            <div className="space-y-5 lg:sticky lg:top-32">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-7 text-[#6e6256]">
                  Homes, interiors, renovations, architectural planning, and project management
                  conversations.
                </p>
              </MotionDiv>
              ...
              >
                ...
                <div className="mt-4 space-y-3">
                  {service.bullets.map((bullet) => (
                    <div key={bullet} className="flex items-start gap-3 rounded-[22px] bg-[#FEFDDF] p-4">
                      <CheckCircle2 size={18} className="mt-0.5 shrink-0 text-[#FFC81E]" />
                      <p className="text-sm leading-6 text-[#6e6256]">{bullet}</p>
                    </div>
                  ))}
                </div>
              </MotionDiv>
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(180deg, rgba(255,253,223,0.08), rgba(28,23,18,0.28)), url('${service.image}')`,
                  }}
                />
                <div className="p-5">
                  <div className="text-[11px] uppercase tracking-[0.24em] text-[#5d8fb2]">Start here</div>
                  <p className="mt-3 text-sm leading-7 text-[#6e6256]">
                    Tell us your brief and we&apos;ll map the right steps for this service.
                  </p>
                  <Link
                    href="/contact"
          ...
          <MotionDiv className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between" variants={itemReveal}>
            <div>
              ...
              <h2 className="mt-5 text-[clamp(2rem,4vw,4.8rem)] font-black leading-[0.92] tracking-[-0.05em] text-[#1c1712]">
                Expand the brief with connected services.
              </h2>
            </div>
            <p className="max-w-2xl text-sm leading-6 text-[#6e6256]">
              Pair this service with another track for a more complete project delivery path.
            </p>
          </MotionDiv>
            ...
            {relatedServices.map((item) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(180deg, rgba(255,253,223,0.08), rgba(28,23,18,0.34)), url('${item.image}')`,
                  }}
                >
